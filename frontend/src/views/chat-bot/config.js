        ...
        questions: [
          {
            questions: "PP",
            answer:
              "PP: 필수재와 사이즈 기준의 교집합이 존재하나 불가한 상태 \n\n" +
      ...
      props: {
        ...
        questions: [
          ...
          },
          {
            ...
            answer:
              "공장부여란 가능통과공정코드를 기반으로 실제로 제작할 공장의 확정코드를 부여합니다.\n\n 제조투입은 확정공정코드가 부여된 후 주문을 투여하는 것 입니다.",
            id: 4,
          },
          {
            questions: "공장변경",
        ...
        questions: [
          {
            questions: "투입능력관리",
            answer:
              "투입능력관리에서는 투입 능력량을 관리하고 공장 배분 정보를 실시간 반영하여 가능한 잔량을 확인할 수 있습니다.",
            id: 1,
          },
          {
            questions: "능력량",
          ...
          },
          {
            questions: "잔여량",
            answer:
              "잔여량이란 조정량에서 투입량을 뺀 값으로 앞으로 더 투입할 수 있는 값입니다.",
            id: 5,
          },
          {
            questions: "히트맵",
            answer:
              "오른쪽 화면의 히트맵은 공장 부하 정도를 나타내는 차트로 색이 진할수록 부하가 심한 상태입니다.",
            id: 6,
          },
          {
            questions: "처음으로",
        ...
        questions: [
          {
            questions: "사이즈 기준",
            answer:
              "사이즈 기준에서 공정/공장별 통과할 수 있는 기준들을 확인할 수 있습니다.",
            id: 1,
          },
          {
            questions: "사이즈 기준 수정",
        ...
        questions: [
          {
            questions: "가능/확통 기준",
            answer:
              "가능/확통 기준에서는 공정별로 가통 코드에 대응하는 공장 리스트와 공장마다 가능한 공정들을 확인할 수 있습니다.",
            id: 1,
          },
          {
      ...
      props: {
        ...
        questions: [
          ...
          },
          {
            questions: "품종별 투입 현황",
            answer:
              "품종별 투입 현황 품종별로 투입 현황을 그래프로 확인할 수 있습니다.",
            id: 3,
          },
          {
            questions: "공장 부하 현황",
            answer:
              "현재 줄강주에 따른 각 공정별 공장에 대한 능력량에 대한 투입량의 퍼센티지로 부하 현황을 나타냅니다.",
            id: 4,
          },
        ...
        questions: [
          {
            questions: "출강Lot",
            answer:
              "출강Lot에서는 투입대기, 기투입 상태(E, F)의 투입량 집계를 확인할 수 있습니다.\n\n" +
          ...
          },
          {
            questions: "차트",
            answer:
              "강종 컬럼을 선택하여 클릭시 각 강종별 차트를 볼 수 있습니다.\n" +
