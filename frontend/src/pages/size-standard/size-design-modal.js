...
const SizeDesignModal = ({ open, handleClose }) => {
    ...
    const resultColumns = [
        { field: "processCD", headerName: "공정", sortable: false, headerAlign: 'center' },
        { field: "value", headerName: "가능한 공장", sortable: false, width: 150, headerAlign: 'center', type: 'number', },
    ];
                    ...
                    <div style={{
                        ...
                        <div>
                            <Button
                                ...
                                variant="contained"
                                onClick={clearResult}
                                style={{ backgroundColor: "#BE2E22", width: "80%", marginRight: "15px" }}
                            >
                                초기화
                            </Button>
                        </div>
                        <div>
                            <Button
                                ...
                                variant="contained"
                                onClick={testClick}
                                style={{ backgroundColor: "#E29E21", width: "50%", marginRight: "15px",marginLeft:"0px" }}
                            >
                                설계
                            </Button>
                        </div>
                    </div>
                    <div style={{ height: 300, display: "flex", justifyContent: "space-between", flexDirection: "row", }}>
                        <div>
                            <Card
                                elevation={3}
                                style={{
                        ...
                        <div>
                            {resultFlag ? <div style={{ height: 300, display: "flex", justifyContent: "center", }}>
                                <Card
                                    elevation={3}
                                    style={{
                                        flexBasis: "85",
