...
(function (root, factory) {
  ...
  function (window) {
    ...
    var notifyCreate = function (
      ...
      var newNotifySettingsBackup = commonExtendOptions(
        true,
        newNotifySettings,
        {}
      );
      ...
      if (
        ...
        message.length > newNotifySettings.messageMaxLength
      ) {
      ...
      if (message.length > newNotifySettings.messageMaxLength) {
        message =
          message.substring(0, newNotifySettings.messageMaxLength) + "...";
      }
      ...
      if (newNotifySettings.backOverlay) {
        ...
        ntflxNotifyOverlay.className = newNotifySettings.cssAnimation
          ? "nx-with-animation"
          : "";
        ntflxNotifyOverlay.style.animationDuration =
      ...
      ntflxNotify.className =
        ...
        " " +
        (newNotifySettings.clickToClose ? "nx-notify-click-to-close" : "");
      ...
      // font-family: begin
      ntflxNotify.style.fontFamily =
        '"' + newNotifySettings.fontFamily + '", ' + defaultFontFamily;
      // font-family: end

      // use css animation: begin
      if (newNotifySettings.cssAnimation) {
        ntflxNotify.style.animationDuration =
          newNotifySettings.cssAnimationDuration + "ms";
      }
      ...
      if (
        ...
        window.document
          .getElementById(notifySettings.wrapID)
          .appendChild(ntflxNotify);
      }
      ...
      if (eachNotifyElement) {
        ...
        var hideNotifyElementsAndOverlay = function () {
          ...
          var removeOverlay = window.document.getElementById(
            notifySettings.overlayID
          );
        ...
        var removeNotifyElmentsAndWrapper = function () {
          ...
          if (
            ntflxNotifyWrap.childElementCount <= 0 &&
            ntflxNotifyWrap.parentNode !== null
          ) {
        ...
        if (
          typeof callbackOrOptions === "function" ||
          newNotifySettings.clickToClose
        ) {
      ...
      if (newNotifySettings.showOnlyTheLastOne && notifyCreateCounter > 0) {
        ...
        for (var i = 0; i < allNotifyElmNotTheLastOne.length; i++) {
          ...
          if (eachNotifyElmNotLastOne.parentNode !== null) {
            eachNotifyElmNotLastOne.parentNode.removeChild(
              eachNotifyElmNotLastOne
            );
          }
        }
      }
